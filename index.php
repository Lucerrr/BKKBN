...
<header class="hero-section text-center position-relative overflow-hidden">
    ...
    <div class="container position-relative" style="z-index: 2;">
        ...
        <p class="lead mb-5 mx-auto" style="max-width: 800px;">
            Portal informasi dan layanan resmi Dinas Pengendalian Penduduk dan Keluarga Berencana Kabupaten Muna Barat. Menuju masyarakat yang sehat, mandiri, dan sejahtera.
        </p>
    ...
    <div class="container py-4">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7" data-aos="fade-left">
                ...
                <h2 class="h2 fw-bold mb-4 text-dark lh-base">Komitmen Pelayanan dalam Mewujudkan Keluarga Muna Barat Berkualitas dan Sejahtera</span></h2>
